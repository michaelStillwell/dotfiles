...
require("lazy").setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { "stylua" },
        xml = { "csharpier", stop_after_first = true },
        ["xaml"] = { "csharpier" },
        axaml = { "csharpier" },
        ["axml"] = { "csharpier" },
...
map("<leader>tf", "<cmd>ToggleTerm direction=float<CR>", "[F]loating")
map("<leader>th", "<cmd>ToggleTerm direction=horizontal<CR>", "[F]loating")
map("<leader>tv", "<cmd>ToggleTerm direction=vertical<CR>", "[F]loating")
-- map("<leader>tv", "<cmd>ToggleTerm direction=vertical<CR>", "[F]loating")

-- neovide
if vim.g.neovide then
  vim.print("hello neovide")
